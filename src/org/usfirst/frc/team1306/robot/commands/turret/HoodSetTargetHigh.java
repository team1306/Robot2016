...
/**
 * A command for setting the hood to a set high target. This can be used when
 * Vision targeting isn't working (like if another robot is defending us).
 * Making this a command allows it to be linked to buttons on the secondary
 * controller.
 */
public class HoodSetTargetHigh extends CommandBase {
	...
	protected void initialize() {
		hood.setTarget(HoodTarget.HIGH);
	}
